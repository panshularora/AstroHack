...
export const Controls: React.FC<ControlsProps> = ({
  ...
  return (
    <>
      {/* Top Right Tool Pill */}
      <div className="absolute top-20 right-6 z-30 flex flex-col bg-zinc-950/80 border border-white/10 rounded-xl p-1 backdrop-blur-md shadow-2xl text-zinc-300">
        <button
          onClick={onZoomIn}
      ...
      {/* Bottom Right Compass Floating Icon */}
      <div className="absolute bottom-6 right-6 z-30">
        <button
          onClick={onResetView}
          className="p-3 rounded-full bg-zinc-950/80 hover:bg-zinc-800/90 text-zinc-300 hover:text-white border border-white/15 backdrop-blur-md transition-all shadow-xl hover:rotate-45 active:scale-95 cursor-pointer"
