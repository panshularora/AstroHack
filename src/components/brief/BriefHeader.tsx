...
export function BriefHeader() {
  ...
  return (
    <div className="mb-12">
      ...
      <div className="bg-gradient-to-br from-[#1a1b26] to-[#12131c] border border-white/10 rounded-[2rem] p-6 md:p-10 relative overflow-hidden shadow-2xl group">
        <div className="absolute top-0 right-0 w-96 h-96 bg-primary/10 rounded-full blur-[100px] -z-10 group-hover:bg-primary/20 transition-colors duration-1000" />
        ...
        <div className="flex flex-col md:flex-row gap-8 items-start relative z-10">
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-4">
              <span className="px-3 py-1 rounded-full bg-primary/20 text-primary border border-primary/20 text-[10px] font-bold uppercase tracking-wider flex items-center gap-1.5">
          ...
          {/* Reflection Sidebar */}
          <div className="w-full md:w-72 shrink-0 bg-white/5 border border-white/10 rounded-3xl p-6 backdrop-blur-sm">
            <h4 className="text-[10px] font-bold text-primary uppercase tracking-wider mb-3 flex items-center gap-1.5">
              <Sparkles className="w-3 h-3" /> Cosmic Memory Insight
            </h4>
            <p className="text-sm text-white/90 italic leading-relaxed mb-4">
              "{reflection}"
            </p>
            <button className="text-xs font-bold text-white hover:text-primary transition-colors flex items-center gap-1">
