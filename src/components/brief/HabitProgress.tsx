...
export function HabitProgress() {
  const stats = [
    ...
    { icon: <MessageSquare className="w-5 h-5 text-primary" />, label: "AI Check-ins", value: mockHabitProgress.aiCheckIns },
  ...
  return (
    <div className="bg-card border border-white/10 rounded-3xl p-6 md:p-8 h-full">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {stats.map((stat, i) => (
          <div key={i} className="flex flex-col items-center justify-center p-4 rounded-2xl bg-white/5 border border-white/5 text-center group hover:bg-white/10 transition-colors cursor-default">
