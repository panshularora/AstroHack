...
export function LookingAhead() {
  return (
    <div className="text-center py-16 border-t border-white/10 relative overflow-hidden">
      ...
      <div className="w-12 h-12 mx-auto bg-primary/20 rounded-full flex items-center justify-center mb-6">
      ...
      <button className="mx-auto flex items-center gap-2 text-sm font-bold text-white px-6 py-3 rounded-full bg-white/5 border border-white/10 hover:bg-white/10 transition-colors">
