...
export function WeeklyReflection() {
  return (
    <div className="bg-gradient-to-br from-blue-500/10 to-transparent border border-blue-500/20 rounded-3xl p-6 md:p-8 relative overflow-hidden group hover:border-blue-500/40 transition-colors cursor-pointer h-full flex flex-col justify-center">
