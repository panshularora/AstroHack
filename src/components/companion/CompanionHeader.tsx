    ...
    <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-8 mt-4 md:mt-8 px-4 md:px-0">
      <div className="flex items-center gap-4 w-full md:w-auto">
        <div className="relative shrink-0">
          ...
          <div className="relative w-14 h-14 bg-gradient-to-tr from-primary to-blue-500 rounded-2xl flex items-center justify-center border border-white/20 shadow-lg">
      ...
      <div className="flex items-center gap-3 bg-card border border-white/10 rounded-2xl p-3 w-full md:w-auto overflow-x-auto scrollbar-hide">
