...
export function MemoryViewer() {
  const memories = [
    ...
    { id: 2, type: 'prediction', icon: <Target className="w-4 h-4 text-brand" />, title: "Job Offer in Tech", date: "Late Aug 2026", summary: "88% confidence of new offer. Status: Pending." },
      ...
      <div className="space-y-3">
        {memories.map(mem => (
          <div key={mem.id} className="p-4 rounded-lg bg-surface-2 border border-line hover:border-line-strong transition-colors group">
            ...
            <div className="text-[10px] uppercase font-bold tracking-wider text-brand mb-2">{mem.date}</div>
