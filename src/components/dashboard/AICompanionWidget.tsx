    ...
    <div className="bg-surface border border-line rounded-lg p-6 h-full flex flex-col shadow-xl">
      ...
      <div className="flex items-center justify-between mb-5">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full bg-brand/20 border border-brand/30 flex items-center justify-center shadow-[0_0_15px_rgba(107,33,168,0.3)]">
        ...
        {typing && (
          ...
          >
            ...
            <div className="flex gap-1">
              {[0, 0.2, 0.4].map(d => (
                <motion.div key={d} className="w-1.5 h-1.5 bg-brand/60 rounded-full"
        ...
        {showResponse && (
          ...
          >
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-[10px] font-bold text-brand uppercase tracking-wider">AI Response</span>
            </div>
