      ...
      <div className="space-y-4 flex-1">
        {spotlightAstrologers.map((ast, i) => (
          <motion.div
            ...
            className="relative bg-white/3 hover:bg-white/6 border border-white/8 hover:border-white/15 rounded-2xl p-4 transition-all group overflow-hidden"
          >
            ...
            <div className="flex items-center gap-3 mb-3">
              <img src={ast.avatar} alt={ast.name} className="w-11 h-11 rounded-full border border-white/10 object-cover shrink-0" />
            ...
            <div className="flex gap-2 mb-3">
              {[
                ...
                <div key={s.val} className={`flex items-center gap-1 text-[10px] font-medium ${s.color} bg-white/4 px-2 py-1 rounded-full border border-white/8`}>
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 py-2 text-[11px] font-bold bg-white/5 hover:bg-white/10 border border-white/10 text-white rounded-xl transition-colors"
              >
                View Profile
              </button>
              <button
                onClick={() => navigate("/app/match")}
                className="flex-1 py-2 text-[11px] font-bold bg-primary/15 hover:bg-primary/25 border border-primary/30 text-primary rounded-xl transition-colors flex items-center justify-center gap-1.5"
              >
