            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <h2 className="text-xl font-bold font-display text-white">AI Proactive Pattern Discovery Engine</h2>
                  <Badge variant="gold" size="sm" className="font-mono">Unasked Insights</Badge>
                </div>
