...
export function EmptyPredictions() {
  return (
    <div className="flex flex-col items-center justify-center p-12 text-center h-full min-h-[400px]">
      <div className="w-24 h-24 bg-brand-light rounded-[32px] flex items-center justify-center mb-6 relative rotate-3 hover:rotate-0 transition-transform duration-500">
        <Target className="w-10 h-10 text-brand" />
        <div className="absolute -bottom-2 -right-2 w-8 h-8 bg-surface border border-line rounded-full flex items-center justify-center">
      ...
      <Button variant="outline" className="border-line-strong gap-2">
