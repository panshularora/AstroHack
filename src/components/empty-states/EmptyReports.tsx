  ...
  return (
    <div className="flex flex-col items-center justify-center p-12 text-center h-full min-h-[400px]">
      <div className="relative mb-8">
        <div className="w-20 h-24 bg-white/5 border border-white/10 rounded-xl absolute -left-12 top-4 -rotate-12 blur-[2px] flex items-center justify-center opacity-50">
          <ChartPie className="w-6 h-6 text-[#9CA3AF]" />
        </div>
        <div className="w-20 h-24 bg-white/5 border border-white/10 rounded-xl absolute -right-12 top-4 rotate-12 blur-[2px] opacity-50" />
        
        <div className="w-24 h-32 bg-card border-2 border-primary/20 rounded-xl relative z-10 flex flex-col items-center justify-center shadow-[0_0_30px_rgba(139,92,246,0.15)]">
