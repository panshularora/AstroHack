    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center pt-24 pb-12 overflow-hidden">
      ...
      <div className="container px-6 mx-auto grid lg:grid-cols-2 gap-16 items-center relative z-10">
        <motion.div
          ...
          className="space-y-8"
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-sm font-medium text-lavender">
            <Star className="w-4 h-4" />
            <span>The Future of Astrology</span>
          </div>
          <h1 className="text-5xl lg:text-7xl font-bold tracking-tighter leading-tight bg-clip-text text-transparent bg-gradient-to-r from-white via-lavender to-secondary">
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <Button size="lg" variant="outline" className="h-12 px-8 text-base text-white border-white/20 hover:bg-white/10" onClick={() => navigate('/login')}>
              Sign In
            </Button>
          </div>
        </motion.div>
        ...
        >
          ...
          >
            <Card className="bg-card/70 backdrop-blur-xl border-white/20">
              <CardContent className="p-5 space-y-4">
                <div className="flex justify-between items-center border-b border-white/10 pb-3">
                  <span className="text-sm font-semibold text-lavender">Daily Cosmic Brief</span>
