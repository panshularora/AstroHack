...
export function TrustSection() {
  return (
    <section id="astrologers" className="py-24 bg-navy relative border-y border-white/5">
      <div className="container px-6 mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="relative bg-card border border-white/10 rounded-3xl p-6 shadow-2xl">
              <div className="flex items-start justify-between border-b border-white/5 pb-6 mb-6">
                <div className="flex items-center gap-4">
                  <img src="https://i.pravatar.cc/150?u=a042581f4e29026704d" alt="Astrologer" className="w-16 h-16 rounded-full border-2 border-white/10 object-cover" />
                  <div>
              ...
              <div className="bg-secondary/5 border border-secondary/20 p-4 rounded-xl">
                <p className="text-sm text-lavender/90 italic">
