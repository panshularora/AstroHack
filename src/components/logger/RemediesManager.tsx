    ...
    <div className="mb-12">
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-white mb-2 flex items-center gap-2">
          <Moon className="w-5 h-5 text-lavender" /> Recommended Remedies
        </h2>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        {remedies.map((r, i) => (
          <motion.div 
            ...
            className="bg-card border border-white/10 rounded-3xl p-6 md:p-8 flex flex-col hover:border-white/20 transition-colors"
          >
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-white/5 rounded-2xl border border-white/5">
                <div className="flex items-center gap-3 text-sm text-white/90 font-medium">
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center ${r.recurring ? 'bg-primary/20 text-primary' : 'bg-white/5 text-[#9CA3AF]'}`}>
                ...
                <button 
                  ...
                  className={`w-12 h-6 rounded-full transition-colors relative flex items-center px-1 cursor-pointer ${r.recurring ? 'bg-primary' : 'bg-white/10'}`}
                >
                  <motion.div 
                    layout
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full bg-navy/50 border border-white/10 rounded-2xl py-3 pl-12 pr-4 text-sm text-white placeholder:text-[#9CA3AF]/50 focus:outline-none focus:border-primary/50 transition-colors"
                />
              </div>
            </div>
          </motion.div>
