      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 overflow-x-auto w-full pb-2 md:pb-0 scrollbar-hide">
          ...
          {['All Categories', 'Astrologer', 'Date Range', 'Status'].map(filter => (
            <button 
              key={filter}
              className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-sm font-medium text-white/90 hover:bg-white/10 hover:border-white/20 transition-colors shrink-0 whitespace-nowrap"
            >
