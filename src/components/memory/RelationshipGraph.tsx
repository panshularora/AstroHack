...
export function RelationshipGraph() {
  ...
  const nodes = [
    ...
    { id: "c1", title: "Dr. Sarah Chen Consultation", type: "consultation", date: "July 15", icon: BookOpen, color: "border-primary bg-primary/20 text-lavender", glow: "shadow-[0_0_20px_rgba(107,33,168,0.4)]" },
  ...
  return (
    <div className="mb-16">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h2 className="text-2xl font-bold text-white mb-2 flex items-center gap-2">
            AI Memory Map & Relationship Network <Network className="w-5 h-5 text-primary" />
          </h2>
        ...
        <button
          ...
          className="px-4 py-2 bg-primary/20 hover:bg-primary/30 border border-primary/40 text-lavender rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer shadow-md"
        >
      ...
      <div className="bg-card border border-white/10 rounded-3xl p-6 md:p-8 relative overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-6 py-6 border-b border-white/10">
          {nodes.map((n, idx) => {
            const Icon = n.icon
            ...
            return (
              <div key={n.id} className="flex flex-col lg:flex-row items-center gap-4 w-full lg:w-auto">
                ...
                >
                  <div className={`w-16 h-16 rounded-2xl border-2 flex items-center justify-center transition-all ${n.color} ${
                ...
                {idx < nodes.length - 1 && (
                  <div className="hidden lg:block w-12 h-0.5 bg-gradient-to-r from-primary/60 to-gold/60 relative">
                    <motion.div
        ...
        <div className="mt-6 p-4 bg-white/4 border border-white/8 rounded-2xl flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-[10px] font-bold text-primary uppercase tracking-wider">Memory Node Detail</span>
          ...
          <div className="p-3 bg-black/40 rounded-xl border border-white/8 text-xs text-lavender font-medium">
