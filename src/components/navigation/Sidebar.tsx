...
export function Sidebar() {
  ...
  return (
    <motion.aside
      ...
      className="border-r border-white/[0.08] bg-[#090A0F]/95 backdrop-blur-xl h-full flex flex-col shrink-0 select-none text-sans relative overflow-hidden"
    >
      {/* Brand Header */}
      <div className="px-4 py-4 border-b border-white/[0.08] flex items-center justify-between">
        <Link to="/app/dashboard" className="flex items-center gap-3 group overflow-hidden">
          <div className="w-8 h-8 rounded-xl bg-amber-500/10 border border-amber-500/30 flex items-center justify-center text-amber-400 shrink-0 group-hover:scale-105 transition-all shadow-md shadow-amber-500/10">
      ...
      <div className="border-t border-white/[0.08] p-3">
        ...
        >
          ...
          {!collapsed && <ChevronRight className="w-3.5 h-3.5 text-[#9CA3AF] group-hover:text-white shrink-0" />}
        </button>
      </div>
    </motion.aside>
  )
