      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        ...
        <div className="relative w-full md:w-64">
          ...
          <input 
            ...
            className="w-full bg-surface-2 border border-line rounded-full py-2.5 pl-10 pr-4 text-sm text-white placeholder:text-[#9CA3AF]/70 focus:outline-none focus:border-line-strong transition-colors"
          />
        </div>
      </div>
        ...
        {mockAnonymizedPredictions.map(prediction => (
          <div key={prediction.id} className="bg-surface border border-line rounded-lg p-6 md:p-8 hover:border-line-strong transition-colors">
            <div className="flex flex-wrap items-center gap-3 mb-5">
              ...
              <span className="text-sm text-white/20">•</span>
              <span className="text-sm text-brand font-bold">{prediction.confidence}% Confidence</span>
