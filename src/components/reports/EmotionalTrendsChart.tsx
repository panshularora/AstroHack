      ...
      <div className="flex-1 min-h-[250px]">
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={data} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
            ...
            <XAxis dataKey="name" tick={{ fontSize: 11, fill: '#78716C', fontFamily: 'var(--font-mono)' }} tickLine={false} axisLine={false} />
            ...
            <Tooltip 
              ...
              itemStyle={{ color: '#fff' }}
            />
            <Area type="monotone" dataKey="clarity" stroke="#D97706" strokeWidth={2} fillOpacity={1} fill="url(#colorClarity)" name="Clarity" />
