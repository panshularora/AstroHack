      ...
      <div className="bg-card border border-white/10 rounded-3xl p-6 md:p-8 space-y-8">
        <div>
          ...
          <div className="grid grid-cols-3 gap-4">
            <button className="flex flex-col items-center gap-3 p-4 bg-white/5 border border-white/10 rounded-2xl hover:border-primary transition-colors">
              <div className="w-full h-16 rounded-xl bg-background border border-white/10 flex items-center justify-center">
                <Moon className="w-6 h-6 text-white" />
              </div>
              <span className="text-sm font-bold text-white">Dark</span>
            </button>
            <button className="flex flex-col items-center gap-3 p-4 bg-white/5 border border-white/10 rounded-2xl opacity-50 cursor-not-allowed">
            ...
            <button className="flex flex-col items-center gap-3 p-4 bg-white/10 border border-primary rounded-2xl">
              <div className="w-full h-16 rounded-xl bg-gradient-to-r from-background to-white border border-white/20 flex items-center justify-center shadow-inner">
        ...
        <div className="space-y-4">
          <h3 className="text-lg font-bold text-white flex items-center gap-2 mb-4">
            <Type className="w-5 h-5 text-primary" /> Accessibility
          </h3>
