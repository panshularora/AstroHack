    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md">
        <motion.div
          ...
          className="relative w-full max-w-5xl bg-card border border-white/10 rounded-3xl p-6 md:p-8 shadow-2xl overflow-hidden max-h-[92vh] flex flex-col"
        >
          {/* Header */}
          <div className="flex items-center justify-between border-b border-white/10 pb-4 mb-6 shrink-0">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-2xl bg-gradient-to-tr from-primary to-purple-500 border border-primary/30 flex items-center justify-center text-white shadow-lg">
          ...
          <div className="flex items-center justify-between gap-3 mb-6 flex-wrap">
              ...
              {presets.map((_, idx) => (
                <button
                  ...
                  className={`px-4 py-2 rounded-xl text-xs font-bold transition-all ${
                    selectedPreset === idx
                      ? "bg-primary text-white border border-primary/40 shadow-md"
            ...
            <button
              ...
              className="px-4 py-2 bg-white/5 hover:bg-white/10 border border-white/10 text-white rounded-xl text-xs font-bold transition-colors flex items-center gap-1.5 cursor-pointer"
            >
              <RefreshCw className={`w-3.5 h-3.5 ${isSimulating ? "animate-spin text-primary" : ""}`} />
          ...
          <div className="flex-1 overflow-y-auto pr-1">
            <div className="grid md:grid-cols-2 gap-6 relative">
              {/* Option A */}
              <div className="bg-white/3 border border-white/8 rounded-3xl p-6 relative flex flex-col justify-between hover:border-green-500/30 transition-all">
                <div className="space-y-4">
                  ...
                  <div className="p-3.5 bg-white/4 rounded-2xl border border-white/5">
                    <span className="text-[10px] text-primary uppercase font-bold tracking-wider block mb-1">Planetary Transit Alignment</span>
                ...
                <div className="mt-6 pt-4 border-t border-white/10 bg-green-500/10 -mx-6 -mb-6 p-4 rounded-b-3xl border-x-0 border-b-0">
              ...
              {/* Option B */}
              <div className="bg-white/3 border border-white/8 rounded-3xl p-6 relative flex flex-col justify-between hover:border-gold/30 transition-all">
                <div className="space-y-4">
                  <div className="flex justify-between items-start">
                ...
                <div className="mt-6 pt-4 border-t border-white/10 bg-gold/10 -mx-6 -mb-6 p-4 rounded-b-3xl border-x-0 border-b-0">
          ...
          <div className="border-t border-white/10 pt-4 mt-6 flex justify-between items-center shrink-0">
            ...
            <button
              onClick={onClose}
              className="px-6 py-2.5 bg-primary hover:bg-primary/90 text-white font-bold rounded-xl text-xs transition-colors shadow-md flex items-center gap-1.5"
            >
