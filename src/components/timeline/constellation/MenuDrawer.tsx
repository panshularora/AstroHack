...
import { X, Filter, Download, Upload, RotateCcw, Sparkles } from 'lucide-react';
...
export const MenuDrawer: React.FC<MenuDrawerProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end bg-black/70 backdrop-blur-md animate-fadeIn font-sans">
      <div className="w-full max-w-sm bg-[#090A0F] border-l border-white/15 h-full p-6 shadow-2xl flex flex-col text-zinc-100 animate-fadeIn">
        ...
        <div className="pt-4 border-t border-white/10 text-center font-mono">
          <p className="text-[11px] text-zinc-500">
            AstroLive Constellation Map v2.0
          </p>
        </div>
      </div>
    </div>
