  ...
  return (
    <div className="mb-12 text-center md:text-left flex flex-col md:flex-row items-center justify-between gap-8">
      <div className="flex-1">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 border border-primary/20 text-xs font-bold text-primary uppercase tracking-wider mb-6">
          <ShieldCheck className="w-4 h-4" /> AstroVerified
        </div>
        <h1 className="text-4xl md:text-6xl font-bold text-white mb-4 leading-tight">
          Trust Built on <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-blue-400">Results.</span>
        </h1>
      ...
      <div className="hidden md:flex flex-1 justify-end">
        <div className="relative w-64 h-64">
          ...
          <div className="absolute inset-4 bg-gradient-to-tr from-primary to-blue-500 rounded-full opacity-20" />
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <ShieldCheck className="w-24 h-24 text-primary drop-shadow-[0_0_15px_rgba(124,58,237,0.5)]" />
          </div>
        </div>
      </div>
    </div>
